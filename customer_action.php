...
if(isset($_POST['btn_action']))
{
	...
	{
		$query = "
		INSERT INTO customer (customer_id, customer_name, customer_contact, customer_email, customer_address, customer_status) 
		VALUES (:customer_id, :customer_name, :customer_contact, :customer_email, :customer_address, :customer_status)
		";
