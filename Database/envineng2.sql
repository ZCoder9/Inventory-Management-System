...
--
-- Host: 127.0.0.1
-- Generation Time: Aug 13, 2021 at 04:37 PM
...
(3, 'Jaydipsinh Padhiyar', 2147483647, 'abc@gmail.com', '-------------------------', 'active');
...
(10, 1, 1312.50, '2021-08-13', 'Jay', 'Ahmedabad', 'cash', 'active', '2021-08-13'),
(11, 1, 2625.00, '2021-08-13', 'Jaydipsinh Padhiyar', 'Vadodra', 'credit', 'active', '2021-08-13');
...
(11, 10, 9, 5, 250.00, 5.00),
(12, 11, 9, 10, 250.00, 5.00);
...
(10, '2021-08-13', 9, 1, 50, 500, 25000, 5, 1250, 26250, 50, 50, 26300, '');
...
(9, 4, 7, 'Elephant Air Gun', 'Elephant Air Gun', 125, 'Nos', 250.00, '5.00', 0.00, 1, 'active', '2021-07-04'),
...
(1, 'Vendor1', 1231231230, 'Bharuch', 'active'),
(2, 'vendor0', 2147483647, 'ahmedabad-vadodra', 'active'),
(3, 'vendor2', 2147483647, 'bharuch-vadodra', 'active'),
(4, 'vendor3', 2147483647, 'daman', 'active'),
(5, 'vendor4', 2147483647, 'a', 'active'),
(6, 'vendor5', 1231231230, 'b', 'active'),
(7, 'vendor6', 2147483647, 'D', 'active');
...
--
ALTER TABLE `inventory_order`
  MODIFY `inventory_order_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=12;

--
-- AUTO_INCREMENT for table `inventory_order_product`
--
ALTER TABLE `inventory_order_product`
  MODIFY `inventory_order_product_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=13;

--
-- AUTO_INCREMENT for table `inward`
--
ALTER TABLE `inward`
  MODIFY `inward_id` int(100) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;
